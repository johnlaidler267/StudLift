...
function Women() {
    return (
        <div>
            <Card style={{ background: "linear-gradient(to right, #6F4D34, #BF7645)", width: "100%", margin: "30px", zIndex: '1', padding: '2em' }}>
                <div style={{ display: "flex", zIndex: '1', color: 'white', width: '100%' }}>
                    <div style={{ display: "flex", flexDirection: 'column', zIndex: '2' }}>
                        <p style={{ color: '#47382C', fontSize: "0.8em", margin: '0px' }}><b>Transform your routine with our stylish and <span style={{ color: 'white' }}>comfortable women's workout wear.</span>"</b></p>
                        <h1 style={{ fontSize: "2.7em", margin: '0px' }}><b>ELEVATE YOUR FITNESS GAME.</b></h1>
                        <p style={{ color: '#47382C', fontSize: "0.8em" }}><b>Get ready to <span style={{ color: 'white' }}>elevate your workout </span> with our <span style={{ color: 'white' }}>top-quality gym clothes</span> for men.</b></p>
                        <br />
                        <div style={{ display: 'flex', flexDirection: 'row', padding: '1em', width: '30em' }}>
                            <Card style={{ margin: '0.2em', backgroundColor: 'transparent', border: 'none' }}>
                                ...
                                <p style={{ fontSize: "0.8em" }}>Get ready to elevate your workout game with our top-quality gym clothes for men.</p>
                            </Card>
                            <Card style={{ margin: '0.2em', backgroundColor: 'transparent', border: 'none' }}>
                                <h3 style={{ fontSize: "1.2em" }}><b>Sweat it out, shine bright.</b></h3>
                                <p style={{ fontSize: "0.8em" }}>Get ready to elevate your workout game with our top-quality gym clothes for men.</p>
                    ...
                    <Card.Img src={illustrationMan} style={{ width: "34em", height: "50em", zIndex: '2', position: 'absolute', left: '29%', top: '-4em' }} />
                    <div style={{ display: "flex", flexDirection: 'column', zIndex: '2', width: '28%', marginLeft: '22em' }}>
                        <p style={{ color: '#47382C', fontSize: "1em" }}><b>Work Hard, turn heads.</b></p>
            ...
            <div style={{ width: '100%', display: 'flex', justifyContent: 'center' }}>
                <Card >
                    <Row>
                        <Card style={{ width: '100%', paddingLeft: "10em", display: 'flex', justifyContent: 'center', alignItems: 'start', height: "20em", background: "linear-gradient(to bottom, #C58256, #CF9773)", color: 'white', zIndex: '5' }}>
                    ...
                    <Row xs={1} md={2} className="g-4">
                        <Col>
                            <Card style={{ padding: "5px", display: 'flex', justifyContent: 'center', alignItems: 'center', height: "20em", background: "linear-gradient(to bottom, #47382C, #BF7645)", color: 'white' }}>
